...
/** `siteY` per station, re-taken 2026-09-13 from the round-three bake (RAIL-VERTICAL.md 3d-3f: the
 *  shoreline pass and the bounded one-sided road projection moved the CBD, the Quay and the built
 *  foreshores by design; 18 stations moved past a metre, Circular Quay's viaduct from -6.7 m to +0.2 m).
 *  The previous list (2026-09-11) was the first conformed-lattice bake. */
const BEFORE: Array<[string, number]> = [
  ...
  ['Bank Street',0],['Banksia',-51.42],['Bankstown',-44.78],['Barangaroo',-65.92],
  ...
  ['Canterbury',-65.63],['Capitol Square',-57.32],['Caringbah',-39.02],['Carlingford',0],
  ['Carlton',-34.95],['Carramar',-61.05],['Castle Hill',59.08],['Casula',-46.02],
  ['Central',-44.54],['Central Chalmers Street',-38.92],['Central Grand Concourse',-45.69],['Chatswood',35.24],
  ['Cheltenham',37.64],['Cherrybrook',96.2],['Chester Hill',-36.58],['Childrens Hospital',0],
  ['Chinatown',-55.33],['Church Street',0],['Circular Quay',-51.13],['Clarendon',-55.39],
  ['Clyde',-60.27],['Coalcliff',74.43],['Coledale',6.13],['Como',-36.64],
  ['Concord West',-58.22],['Convention',0],['Cowan',118.47],['Cronulla',-58.22],
  ...
  ['Dundas',0],['East Hills',-52.34],['East Richmond',-45.37],['Eastwood',-0.41],
  ['Edgecliff',-44.2],['Edmondson Park',-14.14],['Emu Plains',-37.29],['Engadine',115.49],
  ['Epping',27.42],['Erskineville',-54.27],['ES Marks',0],['Exhibition Centre',0],
  ['Fairfield',-57.97],['Fennell Street',0],['Flemington',-52.38],['Gadigal',-32.3],
  ['Glebe',0],['Glenbrook',103.66],['Glenfield',-45.65],['Gordon',52.47],
  ['Gosford',-52.32],['Granville',-59.13],['Green Square',-71.62],['Guildford',-36.55],
  ['Gymea',-7.93],['Harris Park',-52.6],['Hawkesbury River',-59.96],['Hawthorne',0],
  ...
  ['Hurstville',-2.87],['Ingleburn',-38.97],['International Airport',-81.59],['Jannali',-1.38],
  ['John Street Square',0],['Jubilee Park',0],['Juniors Kingsford',0],['Kellyville',-11.22],
  ['Kensington',0],['Killara',47.11],['Kings Cross',-44.57],['Kingsford',0],
  ['Kingsgrove',-55.94],['Kingswood',-18.54],['Kirrawee',21.03],['Kogarah',-54.75],
  ['Koolewong',-57.17],['Lakemba',-35.95],['Lapstone',47.77],['Leichhardt North',0],
  ...
  ['Lisarow',-38.57],['Liverpool',-54.52],['Loftus',37.76],['Macarthur',2.88],
  ['Macdonaldtown',-38.47],['Macquarie Fields',-46.68],['Macquarie Park',-23.49],['Macquarie University',-26.86],
  ['Marayong',-23.53],['Marion',0],['Marrickville',-61.01],['Martin Place',-31.14],
  ['Mascot',-77.8],['Meadowbank',-53.33],['Menangle',13.21],['Menangle Park',8.06],
  ['Merrylands',-48.66],['Milsons Point',-37.06],['Minto',-25.61],['Miranda',-25.16],
  ...
  ['Normanhurst',91.89],['North Ryde',-24.13],['North Strathfield',-52.54],['North Sydney',-30.56],
  ...
  ['Penrith',-41.38],['Penshurst',-15.46],['Petersham',-34.92],['Point Clare',-62.31],
  ['Prince Alfred Square',0],['Punchbowl',-36.91],['Pymble',66],['Pyrmont Bay',0],
  ['Quakers Hill',-36.18],['QVB',-35.3],['Randwick',0],['Redfern',-45.77],
  ['Regents Park',-39.2],['Revesby',-55.44],['Rhodes',-56.83],['Richmond',-47.31],
  ...
  ['Royal Randwick',0],['Rozelle Bay',0],['Scarborough',82.75],['Schofields',-37.79],
  ...
  ['Sydenham',-69.75],['Tallawong',-12.71],['Tascott',-58.39],['Taverners Hill',0],
  ['Telopea',0],['Tempe',-63.56],['The Star',0],['Thirroul',-55.32],
  ['Thornleigh',97.33],['Toongabbie',-40.26],['Town Hall',-39.18],['Tramway Avenue',0],
  ['Turramurra',105.02],['Turrella',-68.3],['UNSW Anzac Parade',0],['UNSW High Street',0],
  ['Victoria Cross',-24.05],['Villawood',-55.25],['Vineyard',-34.47],['Wahroonga',124.44],
  ...
  ['Waverton',-30.25],['Wentworth Park',0],['Wentworthville',-44.13],['Werrington',-45.96],
  ['West Ryde',-40.42],['Westmead',-39.04],['Westmead Hospital',0],['Wiley Park',-32.48],
  ['Windsor',-51.63],['Wolli Creek',-72.23],['Wollstonecraft',-18.99],['Wombarra',48.99],
  ['Woolooware',-39.82],['Woonona',-59.9],['Woy Woy',-68.26],['Wynyard',-39.38],
