...
export const FX = {
  ...
  EAT: 'eat', // flag: F at a Flat White point: heal 2 pips over 4 s + a temp pip for 30 s; $6
  SIZZLE: 'sizzle', // flag: F at a Flat White point: heal 1 now + 1 over 6 s; bystanders heal; $3
...
export const NODES: readonly TalentNode[] = [
  ...
  { id: 10, team: M, tree: 1, tier: 1, slot: 1, name: 'Servo Pie', kind: 'ability', effect: 'Hold F at any Flat White point: a $6 servo pie — heal 2 pips over 4 s and carry one extra pip for 30 s. Not while wanted 4★+.', flavour: 'the good one, not the mince one.', effects: [[FX.EAT, 1]] },
  ...
  { id: 29, team: D, tree: 1, tier: 0, slot: 1, name: 'Sausage Sizzle', kind: 'ability', effect: 'Hold F at any Flat White point: a $3 sausage — heal 1 pip now and 1 over 6 s. Bystanders within 6 m heal 1 pip too and forget your last crime (witnessed reports drop one tier).', flavour: 'onions on top. don\'t start.', effects: [[FX.SIZZLE, 1]] },
